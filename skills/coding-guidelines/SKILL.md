...
└───────────────────────────────────────┘
     ...
     2. Understand Before Changing   (认知与诊断)
        ↓
     3. Design the Smallest Solution (方案与结构)
        ↓
     4. Make Surgical Changes        (干预与约束)
        ↓
     5. Finish With Evidence         (验证与交付)
```
...
- Make the smallest coherent change: every changed line must serve the goal. Avoid adjacent refactors; clean up only what your change made obsolete.
